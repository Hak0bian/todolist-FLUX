  ...
  return (
    <div>
        <div className={st.formDiv}>
            <input className={st.inp} value={state.text} onChange={(e) => dispatch({type: "inp", payload: e.target.value})}/>
            <button className={st.btn} onClick={() => dispatch({type: "add", payload: state.text})}> Add </button>
